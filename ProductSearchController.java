...
public class ProductSearchController implements Initializable {
    ...
    {
        String query = "select products.pid,products.name,products.price from cart inner join products on cart.product_id = products.pid where customer_id = "+ Controller.loggedInCustomer.getId()+";";
